...
function lib:Window(text, preset, closebind)
    ...
    local SearchBoxCorner = Instance.new("UICorner") -- 搜索框圆角
    ...
    SearchBox.BackgroundColor3 = Color3.fromRGB(50, 50, 255) -- 蓝色边框
    SearchBox.Position = UDim2.new(0.0339285731, 0, 0.0564263314, 0)
    SearchBox.Size = UDim2.new(0, 200, 0, 23)
    SearchBox.Font = Enum.Font.Gotham
    SearchBox.PlaceholderText = "搜索功能"
    SearchBox.TextColor3 = Color3.fromRGB(255, 255, 255)
    SearchBox.TextSize = 14.000

    SearchBoxCorner.CornerRadius = UDim.new(0, 10) -- 圆角
