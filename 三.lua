...
local SoundService = game:GetService("SoundService")function Nofitication:Notify(nofdebug,middledebug,all)
...
sound:Play()
game:GetService("Debris"):AddItem(sound, 2)MainContainer.Name="MainContainer"
