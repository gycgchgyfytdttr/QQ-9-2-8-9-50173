...
function lib:Window(text, preset, closebind)
    ...
    FunctionArea.Position = UDim2.new(0.033, 0, 0.17, 0)
    FunctionArea.Size = UDim2.new(0, 107, 0, 25)
    FunctionArea.Visible = false

    FunctionAreaCorner.CornerRadius = UDim.new(0, 6)
    ...
    FunctionAreaTitle.Size = UDim2.new(0, 107, 0, 25)
    ...
    FunctionAreaTitle.TextSize = 12.000
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Keybind(text, keypreset, callback)
            ...
            Keybind.Size = UDim2.new(0, 357, 0, 40)
            ...
            KeybindTitle.Position = UDim2.new(0.035, 0, 0, 0)
            KeybindTitle.Size = UDim2.new(0, 150, 0, 40)
            ...
            KeybindText.Position = UDim2.new(0.035, 0, 0, 0)
            KeybindText.Size = UDim2.new(0, 320, 0, 40)
        ...
        function tabcontent:Input(text, placeholder, callback)
            ...
            Input.Size = UDim2.new(0, 357, 0, 40)
            ...
            InputTitle.Position = UDim2.new(0.035, 0, 0, 0)
            InputTitle.Size = UDim2.new(0, 150, 0, 40)
            ...
            InputFrame.Position = UDim2.new(0.55, 0, 0.25, 0)
            InputFrame.Size = UDim2.new(0, 150, 0, 20)
        ...
        function tabcontent:List(text, items, callback)
            ...
            List.Size = UDim2.new(0, 357, 0, 150)
            ...
            ListTitle.Position = UDim2.new(0.035, 0, 0, 0)
            ListTitle.Size = UDim2.new(0, 150, 0, 25)
            ...
            ListFrame.Position = UDim2.new(0.035, 0, 0.2, 0)
            ListFrame.Size = UDim2.new(0, 330, 0, 110)
            ...
            for i, item in pairs(items) do
                ...
                ListItem.Size = UDim2.new(0, 320, 0, 25)
        ...
        function tabcontent:Info(text)
            ...
            Info.Size = UDim2.new(0, 357, 0, 50)
            ...
            InfoText.Size = UDim2.new(0, 357, 0, 50)
            InfoText.Font = Enum.Font.Gotham
            InfoText.Text = text
            InfoText.TextColor3 = Color3.fromRGB(200, 200, 200)
            InfoText.TextSize = 12.000
        ...
        function tabcontent:Section(text)
            ...
            Section.Size = UDim2.new(0, 357, 0, 35)
            ...
            SectionTitle.Size = UDim2.new(0, 357, 0, 35)
