...
local redzlib = {
	Themes = {
		...
		GreenSilver = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 150, 0)),
		...
		RedSilver = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 0, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 50, 50)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 0, 0))
			}),
		...
		GoldSilver = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(218, 165, 32)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 215, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(218, 165, 32))
			}),
			["Color Hub 2"] = Color3.fromRGB(245, 245, 245),
			["Color Stroke"] = Color3.fromRGB(210, 210, 210),
		...
		PurpleSilver = {
			["Color Hub 1"] = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(160, 0, 160)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(128, 0, 128))
			}),
			["Color Hub 2"] = Color3.fromRGB(235, 235, 235),
			["Color Stroke"] = Color3.fromRGB(195, 195, 195),
			["Color Theme"] = Color3.fromRGB(160, 0, 160),
			["Color Text"] = Color3.fromRGB(0, 0, 0),
			["Color Dark Text"] = Color3.fromRGB(95, 95, 95)
		}
	},
	Info = {
		Version = "1.1.0"
...
function redzlib:MakeWindow(Configs)
	...
	function Window:ShowSettings()
		...
		local SettingsPanel = Create("Frame", MainFrame, {
		...
		Make("Corner", SettingsPanel)
		Make("Stroke", SettingsPanel)
		
		local CloseBtn = Create("TextButton", SettingsPanel, {
		...
		Make("Corner", CloseBtn)
		
		local TitleLabel = InsertTheme(Create("TextLabel", SettingsPanel, {
		...
		local ScrollFrame = Create("ScrollingFrame", SettingsPanel, {
		...
		-- 主题颜色选择
		local ThemeSection = Create("Frame", ScrollFrame, {
			Size = UDim2.new(1, 0, 0, 30),
			BackgroundTransparency = 1
		})
		
		local ThemeLabel = InsertTheme(Create("TextLabel", ThemeSection, {
			Size = UDim2.new(1, 0, 1, 0),
			Text = "主题颜色",
			TextColor3 = Theme["Color Text"],
			Font = Enum.Font.GothamMedium,
		...
		local ThemeDropdown = Create("TextButton", ThemeSection, {
		...
		Make("Corner", ThemeDropdown)
		
		-- UI背景边框颜色
		local BorderSection = Create("Frame", ScrollFrame, {
			Size = UDim2.new(1, 0, 0, 30),
			BackgroundTransparency = 1
		})
		
		local BorderLabel = InsertTheme(Create("TextLabel", BorderSection, {
			Size = UDim2.new(1, 0, 1, 0),
			Text = "边框颜色",
			TextColor3 = Theme["Color Text"],
			Font = Enum.Font.GothamMedium,
		...
		local BorderDropdown = Create("TextButton", BorderSection, {
			Size = UDim2.new(0, 120, 0, 25),
			Position = UDim2.new(1, -10, 0.5, 0),
			AnchorPoint = Vector2.new(1, 0.5),
			BackgroundColor3 = Theme["Color Stroke"],
		...
		Make("Corner", BorderDropdown)
		
		-- UI透明度
		local TransparencySection = Create("Frame", ScrollFrame, {
			Size = UDim2.new(1, 0, 0, 50),
			BackgroundTransparency = 1
		})
		
		local TransparencyLabel = InsertTheme(Create("TextLabel", TransparencySection, {
			Size = UDim2.new(1, 0, 0, 25),
			Text = "UI透明度",
			TextColor3 = Theme["Color Text"],
			Font = Enum.Font.GothamMedium,
		...
		local TransparencyValue = InsertTheme(Create("TextLabel", TransparencySection, {
		...
		local TransparencyBar = Create("Frame", TransparencySection, {
			Size = UDim2.new(1, 0, 0, 10),
			Position = UDim2.new(0, 0, 1, -15),
			BackgroundColor3 = Theme["Color Stroke"]
		})
		Make("Corner", TransparencyBar)
		
		local TransparencyIndicator = Create("Frame", TransparencyBar, {
			Size = UDim2.new(0.5, 0, 1, 0),
			BackgroundColor3 = Theme["Color Theme"]
		})
		Make("Corner", TransparencyIndicator)
		
		-- 圆角设置
		local CornerSection = Create("Frame", ScrollFrame, {
			Size = UDim2.new(1, 0, 0, 50),
			BackgroundTransparency = 1
		})
		
		local CornerLabel = InsertTheme(Create("TextLabel", CornerSection, {
			Size = UDim2.new(1, 0, 0, 25),
			Text = "圆角大小",
			TextColor3 = Theme["Color Text"],
			Font = Enum.Font.GothamMedium,
		...
		local CornerValue = InsertTheme(Create("TextLabel", CornerSection, {
			Size = UDim2.new(0, 40, 0, 25),
			Position = UDim2.new(1, -10, 0, 0),
			AnchorPoint = Vector2.new(1, 0),
			Text = "7",
		...
		local CornerBar = Create("Frame", CornerSection, {
			Size = UDim2.new(1, 0, 0, 10),
			Position = UDim2.new(0, 0, 1, -15),
			BackgroundColor3 = Theme["Color Stroke"]
		})
		Make("Corner", CornerBar)
		
		local CornerIndicator = Create("Frame", CornerBar, {
			Size = UDim2.new(0.7, 0, 1, 0),
			BackgroundColor3 = Theme["Color Theme"]
		})
		Make("Corner", CornerIndicator)
	...
	function Window:ShowInfo()
		if MainFrame:FindFirstChild("InfoPanel") then return end
		
		local InfoPanel = Create("Frame", MainFrame, {
			Size = UDim2.new(1, 0, 1, 0),
			Position = UDim2.new(0, 0, 0, 0),
			BackgroundColor3 = Theme["Color Hub 2"],
			BackgroundTransparency = 0.1,
		...
		Make("Corner", InfoPanel)
		Make("Stroke", InfoPanel)
		
		local CloseBtn = Create("TextButton", InfoPanel, {
			Size = UDim2.new(0, 20, 0, 20),
			Position = UDim2.new(1, -10, 0, 10),
			BackgroundColor3 = Color3.fromRGB(255, 50, 50),
			Text = "X",
		...
		local TitleLabel = InsertTheme(Create("TextLabel", InfoPanel, {
			Size = UDim2.new(1, 0, 0, 30),
			Position = UDim2.new(0, 0, 0, 0),
			Text = "信息",
			TextColor3 = Theme["Color Text"],
		...
		local InfoText = InsertTheme(Create("TextLabel", InfoPanel, {
			Size = UDim2.new(1, -20, 1, -60),
			Position = UDim2.new(0, 10, 0, 40),
			Text = "DE HUB V2 Ul by神青",
			TextColor3 = Theme["Color Text"],
			Font = Enum.Font.Gotham,
			TextSize = 12,
			BackgroundTransparency = 1,
