...
local redzlib = {
	Themes = {
		...
		SilverGreen = {
			...
			["Color Stroke"] = Color3.fromRGB(0, 255, 0), -- 纯绿色边框
			["Color Theme"] = Color3.fromRGB(0, 200, 0),
			["Color Text"] = Color3.fromRGB(0, 100, 0),
			["Color Dark Text"] = Color3.fromRGB(0, 150, 0)
		},
		BlueSilver = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(100, 100, 255)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(150, 150, 255)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(100, 100, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(200, 200, 255),
			["Color Stroke"] = Color3.fromRGB(220, 220, 255),
			["Color Theme"] = Color3.fromRGB(0, 100, 255),
			["Color Text"] = Color3.fromRGB(0, 0, 100),
			["Color Dark Text"] = Color3.fromRGB(0, 0, 150)
		},
		RedGold = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 100, 100)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 150, 150)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 100, 100))
			}),
			["Color Hub 2"] = Color3.fromRGB(255, 200, 200),
			["Color Stroke"] = Color3.fromRGB(255, 215, 0),
			["Color Theme"] = Color3.fromRGB(255, 100, 0),
			["Color Text"] = Color3.fromRGB(150, 50, 0),
			["Color Dark Text"] = Color3.fromRGB(200, 100, 0)
		},
		PurplePink = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(150, 100, 255)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(200, 150, 255)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(150, 100, 255))
			}),
			["Color Hub 2"] = Color3.fromRGB(220, 200, 255),
			["Color Stroke"] = Color3.fromRGB(255, 105, 180),
			["Color Theme"] = Color3.fromRGB(200, 0, 255),
			["Color Text"] = Color3.fromRGB(100, 0, 100),
			["Color Dark Text"] = Color3.fromRGB(150, 0, 150)
		},
		Ocean = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 100, 150)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 150, 200)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 100, 150))
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 200, 255),
			["Color Stroke"] = Color3.fromRGB(0, 255, 255),
			["Color Theme"] = Color3.fromRGB(0, 100, 255),
			["Color Text"] = Color3.fromRGB(0, 50, 100),
			["Color Dark Text"] = Color3.fromRGB(0, 75, 150)
		},
		Forest = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 100, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 150, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 100, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 200, 0),
			["Color Stroke"] = Color3.fromRGB(50, 255, 50),
			["Color Theme"] = Color3.fromRGB(0, 255, 0),
			["Color Text"] = Color3.fromRGB(0, 50, 0),
			["Color Dark Text"] = Color3.fromRGB(0, 75, 0)
		},
		Sunset = {
			["Color Hub 1"] = ColorSequence.new({
			...
			["Color Hub 2"] = Color3.fromRGB(255, 200, 100),
		...
		Midnight = {
			...
			["Color Hub 2"] = Color3.fromRGB(0, 0, 150),
			["Color Stroke"] = Color3.fromRGB(0, 255, 255),
			["Color Theme"] = Color3.fromRGB(0, 100, 255),
			["Color Text"] = Color3.fromRGB(200, 200, 255),
			["Color Dark Text"] = Color3.fromRGB(150, 150, 255)
		},
		Candy = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 150, 200)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 200, 220)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 150, 200))
			}),
			["Color Hub 2"] = Color3.fromRGB(255, 220, 240),
			["Color Stroke"] = Color3.fromRGB(255, 100, 180),
			["Color Theme"] = Color3.fromRGB(255, 0, 127),
			["Color Text"] = Color3.fromRGB(150, 0, 75),
			["Color Dark Text"] = Color3.fromRGB(200, 0, 100)
		},
		Lava = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 50, 0)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 100, 0)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 50, 0))
			}),
			["Color Hub 2"] = Color3.fromRGB(255, 150, 0),
			["Color Stroke"] = Color3.fromRGB(255, 255, 0),
		...
		Emerald = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 150, 100)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 200, 150)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 150, 100))
			}),
			["Color Hub 2"] = Color3.fromRGB(0, 255, 200),
			["Color Stroke"] = Color3.fromRGB(0, 255, 0),
			["Color Theme"] = Color3.fromRGB(0, 255, 100),
			["Color Text"] = Color3.fromRGB(0, 100, 50),
			["Color Dark Text"] = Color3.fromRGB(0, 150, 75)
		},
		Royal = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(75, 0, 150)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(100, 0, 200)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(75, 0, 150))
			}),
			["Color Hub 2"] = Color3.fromRGB(150, 0, 255),
			["Color Stroke"] = Color3.fromRGB(255, 215, 0),
			["Color Theme"] = Color3.fromRGB(150, 0, 255),
			["Color Text"] = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(200, 200, 200)
...
function redzlib:MakeWindow(Configs)
	...
	-- 添加信息标签函数
	local function AddInfoLabels(container)
		container:AddLabel("您的用户名: "..game.Players.LocalPlayer.Name)
		container:AddLabel("您的名称: "..game.Players.LocalPlayer.DisplayName)
		container:AddLabel("您的语言: "..game.Players.LocalPlayer.LocaleId)
		
		local country = "未知"
		pcall(function()
			country = game:GetService("LocalizationService"):GetCountryRegionForPlayerAsync(game.Players.LocalPlayer)
		end)
		container:AddLabel("您的国家: "..country)
		
		container:AddLabel("您的账户年龄(天): "..game.Players.LocalPlayer.AccountAge)
		container:AddLabel("您的账户年龄(年): "..math.floor(game.Players.LocalPlayer.AccountAge/365*100)/(100))
		
		local executor = "未知"
		if identifyexecutor then
			executor = identifyexecutor() or "未知"
		end
		container:AddLabel("您使用的注入器："..executor)
		
		container:AddLabel("您当前的服务器ID: "..game.PlaceId)
	end
	...
	local ContainerList = {}
	local InfoContainer, SettingsContainer
	...
	-- 创建设置和信息容器
	SettingsContainer = InsertTheme(Create("ScrollingFrame", {
		Size = UDim2.new(1, 0, 1, 0),
		Position = UDim2.new(0, 0, 1),
		AnchorPoint = Vector2.new(0, 1),
		ScrollBarThickness = 1.5,
	...
	InfoContainer = InsertTheme(Create("ScrollingFrame", {
		Size = UDim2.new(1, 0, 1, 0),
		Position = UDim2.new(0, 0, 1),
		AnchorPoint = Vector2.new(0, 1),
		ScrollBarThickness = 1.5,
	...
	table.insert(ContainerList, SettingsContainer)
	table.insert(ContainerList, InfoContainer)
	
	-- 设置按钮点击事件
	SettingsButton.Activated:Connect(function()
		for _,Frame in pairs(ContainerList) do
			if Frame:IsA("ScrollingFrame") and Frame ~= SettingsContainer then
				Frame.Parent = nil
			end
		end
		SettingsContainer.Parent = Containers
		SettingsContainer.Size = UDim2.new(1, 0, 1, 150)
		CreateTween({SettingsContainer, "Size", UDim2.new(1, 0, 1, 0), 0.3})
		
		-- 添加设置选项
		if not SettingsContainer:FindFirstChild("SettingsAdded") then
			local SettingsTab = {
				AddSection = function(config) return Window:MakeTab():AddSection(config) end,
				AddDropdown = function(config) return Window:MakeTab():AddDropdown(config) end,
				AddToggle = function(config) return Window:MakeTab():AddToggle(config) end,
				AddSlider = function(config) return Window:MakeTab():AddSlider(config) end,
				AddLabel = function(config) return Window:MakeTab():AddLabel(config) end
			}
			
			SettingsTab.Cont = SettingsContainer
			SettingsTab:AddSection("UI 设置")
			
			SettingsTab:AddDropdown({
				Name = "背景边框颜色",
				Options = {"SilverGreen", "BlueSilver", "RedGold", "PurplePink", "Ocean", "Forest", "Sunset", "Neon", "Midnight", "Candy", "Lava", "Emerald", "Royal", "Darker", "Dark", "Purple"},
				Default = redzlib.Save.Theme or "Darker",
			...
			SettingsTab:AddSlider({
				...
				Default = 100,
				Callback = function(v)
					MainFrame.BackgroundTransparency = (100 - v) / 100
				end
			})
			...
			local marker = Create("StringValue", SettingsContainer, {Name = "SettingsAdded", Value = "true"})
		end
	end)
	...
	InfoButton.Activated:Connect(function()
		for _,Frame in pairs(ContainerList) do
			if Frame:IsA("ScrollingFrame") and Frame ~= InfoContainer then
				Frame.Parent = nil
			end
		end
		InfoContainer.Parent = Containers
		InfoContainer.Size = UDim2.new(1, 0, 1, 150)
		CreateTween({InfoContainer, "Size", UDim2.new(1, 0, 1, 0), 0.3})
		
		-- 添加信息标签
		if not InfoContainer:FindFirstChild("InfoAdded") then
			local InfoTab = {
				AddLabel = function(config) return Window:MakeTab():AddLabel(config) end,
				AddSection = function(config) return Window:MakeTab():AddSection(config) end
			}
			
			InfoTab.Cont = InfoContainer
			InfoTab:AddSection("用户信息")
			AddInfoLabels(InfoTab)
			
			local marker = Create("StringValue", InfoContainer, {Name = "InfoAdded", Value = "true"})
		end
	end)
