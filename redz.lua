    ...
    Themes = {
        BlueRed = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 150, 200)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 120, 180)),
        ...
        SilverGreen = {
            ...
            ["Color Hub 2"] = Color3.fromRGB(190, 190, 190),
        ...
        GoldPurple = {
            ...
            ["Color Hub 2"] = Color3.fromRGB(218, 165, 32),
            ["Color Stroke"] = Color3.fromRGB(184, 134, 11),
            ["Color Theme"] = Color3.fromRGB(128, 0, 128),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(255, 255, 200)
        },
        OceanBlue = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 105, 148)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 85, 128)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 105, 148))
            }),
            ["Color Hub 2"] = Color3.fromRGB(0, 95, 138),
            ["Color Stroke"] = Color3.fromRGB(0, 75, 118),
            ["Color Theme"] = Color3.fromRGB(0, 150, 200),
            ["Color Text"] = Color3.fromRGB(240, 240, 240),
            ["Color Dark Text"] = Color3.fromRGB(180, 220, 240)
        },
        FireRed = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 69, 0)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(220, 50, 0)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 69, 0))
            }),
            ["Color Hub 2"] = Color3.fromRGB(235, 60, 0),
            ["Color Stroke"] = Color3.fromRGB(200, 40, 0),
            ["Color Theme"] = Color3.fromRGB(255, 100, 0),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(255, 200, 180)
        },
        Emerald = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 168, 107)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 138, 87)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 168, 107))
            }),
            ["Color Hub 2"] = Color3.fromRGB(0, 153, 97),
            ["Color Stroke"] = Color3.fromRGB(0, 123, 77),
            ["Color Theme"] = Color3.fromRGB(0, 200, 120),
            ["Color Text"] = Color3.fromRGB(240, 240, 240),
            ["Color Dark Text"] = Color3.fromRGB(180, 240, 200)
        },
        RoyalPurple = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(102, 51, 153)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(82, 41, 133)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(102, 51, 153))
            }),
            ["Color Hub 2"] = Color3.fromRGB(92, 46, 143),
            ["Color Stroke"] = Color3.fromRGB(72, 36, 123),
            ["Color Theme"] = Color3.fromRGB(120, 70, 180),
            ["Color Text"] = Color3.fromRGB(240, 240, 240),
            ["Color Dark Text"] = Color3.fromRGB(220, 200, 240)
        },
        SunsetOrange = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 140, 0)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(220, 110, 0)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 140, 0))
            }),
            ["Color Hub 2"] = Color3.fromRGB(235, 125, 0),
            ["Color Stroke"] = Color3.fromRGB(200, 100, 0),
            ["Color Theme"] = Color3.fromRGB(255, 165, 0),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(255, 220, 180)
        },
        IceBlue = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(173, 216, 230)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(153, 196, 210)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(173, 216, 230))
            }),
            ["Color Hub 2"] = Color3.fromRGB(163, 206, 220),
            ["Color Stroke"] = Color3.fromRGB(143, 186, 200),
            ["Color Theme"] = Color3.fromRGB(200, 230, 255),
            ["Color Text"] = Color3.fromRGB(0, 0, 0),
            ["Color Dark Text"] = Color3.fromRGB(50, 50, 80)
        },
        PinkLemonade = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 182, 193)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(230, 162, 173)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 182, 193))
            }),
            ["Color Hub 2"] = Color3.fromRGB(240, 172, 183),
            ["Color Stroke"] = Color3.fromRGB(210, 152, 163),
            ["Color Theme"] = Color3.fromRGB(255, 200, 210),
            ["Color Text"] = Color3.fromRGB(0, 0, 0),
            ["Color Dark Text"] = Color3.fromRGB(80, 50, 60)
        },
        MidnightBlue = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 25, 112)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(15, 15, 92)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(25, 25, 112))
            }),
            ["Color Hub 2"] = Color3.fromRGB(20, 20, 102),
            ["Color Stroke"] = Color3.fromRGB(10, 10, 82),
            ["Color Theme"] = Color3.fromRGB(40, 40, 140),
            ["Color Text"] = Color3.fromRGB(240, 240, 240),
            ["Color Dark Text"] = Color3.fromRGB(180, 180, 220)
        },
        ForestGreen = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(34, 139, 34)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(24, 119, 24)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(34, 139, 34))
            }),
            ["Color Hub 2"] = Color3.fromRGB(29, 129, 29),
            ["Color Stroke"] = Color3.fromRGB(19, 109, 19),
            ["Color Theme"] = Color3.fromRGB(50, 160, 50),
            ["Color Text"] = Color3.fromRGB(240, 240, 240),
        ...
        RubyRed = {
            ["Color Hub 1"] = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(190, 0, 40)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(220, 20, 60))
            }),
            ["Color Hub 2"] = Color3.fromRGB(205, 10, 50),
            ["Color Stroke"] = Color3.fromRGB(175, 0, 30),
            ["Color Theme"] = Color3.fromRGB(240, 40, 80),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(255, 180, 190)
        },
        Amethyst = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(153, 102, 204)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(133, 82, 184)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(153, 102, 204))
            }),
            ["Color Hub 2"] = Color3.fromRGB(143, 92, 194),
            ["Color Stroke"] = Color3.fromRGB(123, 72, 174),
            ["Color Theme"] = Color3.fromRGB(170, 120, 220),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(230, 210, 255)
        },
        Tropical = {
            ["Color Hub 1"] = ColorSequence.new({
                ColorSequenceKeypoint.new(0.00, Color3.fromRGB(0, 206, 209)),
                ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 176, 179)),
                ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 206, 209))
            }),
            ["Color Hub 2"] = Color3.fromRGB(0, 191, 194),
            ["Color Stroke"] = Color3.fromRGB(0, 166, 169),
            ["Color Theme"] = Color3.fromRGB(0, 230, 230),
            ["Color Text"] = Color3.fromRGB(255, 255, 255),
            ["Color Dark Text"] = Color3.fromRGB(180, 240, 240)
        }
    },
    Info = {
        Version = "1.1.0"
...
function redzlib:MakeWindow(Configs)
    ...
    -- 银白绿色渐变背景边框
    local SilverGreenStroke = Create("UIStroke", MainFrame, {
        Thickness = 3,
        ApplyStrokeMode = "Border",
        Transparency = 0.2,
    })

    local SilverGreenGradient = Create("UIGradient", SilverGreenStroke, {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.00, Color3.fromRGB(200, 200, 200)),    -- 银色
            ColorSequenceKeypoint.new(0.25, Color3.fromRGB(180, 220, 180)),    -- 浅绿银
            ColorSequenceKeypoint.new(0.50, Color3.fromRGB(0, 255, 0)),        -- 纯绿色
            ColorSequenceKeypoint.new(0.75, Color3.fromRGB(180, 220, 180)),    -- 浅绿银
            ColorSequenceKeypoint.new(1.00, Color3.fromRGB(200, 200, 200))     -- 银色
        }),
        Rotation = 0
    })
    ...
    RunService.Heartbeat:Connect(function(deltaTime)
        SilverGreenGradient.Rotation = (SilverGreenGradient.Rotation + rotationSpeed * deltaTime) % 360
    end)
    ...
    local titleGradient = Create("UIGradient", Title, {
        Color = ColorSequence.new({
            ColorSequenceKeypoint.new(0.0, Color3.fromRGB(200, 200, 200)),    -- 银色
            ColorSequenceKeypoint.new(0.3, Color3.fromRGB(180, 220, 180)),    -- 浅绿银
            ColorSequenceKeypoint.new(0.5, Color3.fromRGB(0, 255, 0)),        -- 纯绿色
            ColorSequenceKeypoint.new(0.7, Color3.fromRGB(180, 220, 180)),    -- 浅绿银
            ColorSequenceKeypoint.new(1.0, Color3.fromRGB(200, 200, 200))     -- 银色
        }),
        Rotation = 0
    })
    ...
    local function CreateInfoTab()
        ...
        local country = "未知"
        pcall(function()
            country = game:GetService("LocalizationService"):GetCountryRegionForPlayerAsync(game.Players.LocalPlayer)
        end)
        InfoTab:AddLabel("您的国家: "..country)
        ...
        InfoTab:AddLabel("您使用的注入器："..executor)
    ...
    function Window:MakeTab(paste, Configs)
        ...
        -- 添加速度功能
        function Tab:AddSpeed(Configs)
            local Speed = 1
            local speedEnabled = false
            local sudi = nil

            local SpeedToggle = self:AddToggle({
                Title = "走路速度",
                Default = false,
                Callback = function(v)
                    speedEnabled = v
                    if v == true then
                        sudi = game:GetService("RunService").Heartbeat:Connect(function()
            ...
            local SpeedSlider = self:AddSlider({
                Title = "速度设置",
                Description = "拉条",
                Default = 1,
                Min = 1,
        ...
        -- 添加造型类型下拉框
        function Tab:AddFormation(Configs)
            local formationType = "圆形"

            local FormationDropdown = self:AddDropdown({
                Title = "造型类型",
                Options = {"圆形", "直线", "网格", "螺旋"},
                Callback = function(Value)
                    formationType = Value
...
-- 添加设置功能
function redzlib:AddSettings(Window)
    ...
    -- 背景边框颜色选择
    SettingsTab:AddSection("背景边框设置")
    
    local BorderColorDropdown = SettingsTab:AddDropdown({
        Title = "边框颜色主题",
        Options = {
            "SilverGreen", "BlueRed", "GoldPurple", "OceanBlue", 
            "FireRed", "Emerald", "RoyalPurple", "SunsetOrange",
            "IceBlue", "PinkLemonade", "MidnightBlue", "ForestGreen",
            "RubyRed", "Amethyst", "Tropical"
        },
        Default = redzlib.Save.Theme or "SilverGreen",
        Callback = function(selectedTheme)
            redzlib:SetTheme(selectedTheme)
            redzlib.Save.Theme = selectedTheme
            SaveJson("redz library V5.json", redzlib.Save)
        end
    })

    -- UI调整功能
    SettingsTab:AddSection("UI调整")
    ...
    local BorderThicknessSlider = SettingsTab:AddSlider({
        Title = "边框粗细",
        Description = "调整边框厚度",
        Default = 3,
        Min = 1,
    ...
    local AnimationSpeedSlider = SettingsTab:AddSlider({
        Title = "动画速度",
    ...
    local CornerRadiusSlider = SettingsTab:AddSlider({
        Title = "圆角半径",
        Description = "调整界面圆角大小",
        Default = 10,
        Min = 0,
        Max = 20,
        Callback = function(Value)
    ...
    local BlurEffectSlider = SettingsTab:AddSlider({
        Title = "模糊效果",
        Description = "调整背景模糊强度",
        Default = 0,
        Min = 0,
        Max = 10,
        Callback = function(Value)
