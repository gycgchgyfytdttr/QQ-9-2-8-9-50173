...
function Library.new(Library, name, theme)
    ...
    beijingColor = Color3.fromRGB(40, 40, 60)
    ...
    ScriptTitle.TextStrokeTransparency = 0.8
    ...
    local function NPLHKB_fake_script()
        ...
        local function rainbowColors()
            table.insert(list, Color3.fromRGB(0, 100, 255))
            table.insert(list, Color3.fromRGB(0, 150, 255))
            table.insert(list, Color3.fromRGB(0, 200, 255))
            table.insert(list, Color3.fromRGB(100, 200, 255))
            table.insert(list, Color3.fromRGB(0, 150, 255))
        end
        rainbowColors()
        gradient.Color =
    ...
    function window.Tab(window, name, icon)
        ...
        TabText.TextStrokeTransparency = 0.8
        ...
        function tab.section(tab, name, TabVal)
            ...
            SectionText.TextStrokeTransparency = 0.8
            SectionText.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function section:LabelTransparency(text)
                ...
                TextLabelE.TextStrokeTransparency = 0.8
                TextLabelE.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function section.Keybind(section, text, default, callback)
                ...
                KeybindBtn.TextStrokeTransparency = 0.8
                KeybindBtn.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
                ...
                KeybindValue.TextStrokeTransparency = 0.8
                KeybindValue.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function section.Textbox(section, text, flag, default, callback)
                ...
                TextboxBack.TextStrokeTransparency = 0.8
                TextboxBack.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
            ...
            function section.Slider(section, text, flag, default, min, max, precise, callback)
                ...
                SliderBack.TextStrokeTransparency = 0.8
                SliderBack.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
                ...
                SliderValue.TextStrokeTransparency = 0.8
            ...
            function section.Dropdown(section, text, flag, options, callback)
                ...
                DropdownTop.TextStrokeTransparency = 0.8
                DropdownTop.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
                ...
                DropdownText.TextStrokeTransparency = 0.8
                DropdownText.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
