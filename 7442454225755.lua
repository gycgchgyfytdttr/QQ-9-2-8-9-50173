...
function lib:Window(text, preset, closebind)
    ...
    coroutine.wrap(function()
        while wait() do
            ...
            BorderGradient.Color = ColorSequence.new({
                ...
                ColorSequenceKeypoint.new(0.50, Color3.fromHSV((hue + 0.5) % 1, 1, 1)),
    ...
    MiniUI.Name = "MiniUI"
    MiniUI.Parent = ui
    MiniUI.AnchorPoint = Vector2.new(0.5, 0.5)
    MiniUI.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
    MiniUI.Position = UDim2.new(0.5, 0, 0.5, 0)
    ...
    MiniBorder.Name = "MiniBorder"
    MiniBorder.Parent = MiniUI
    MiniBorder.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    ...
    local MiniBorderGradient = Instance.new("UIGradient")
    MiniBorderGradient.Color = ColorSequence.new({
    ...
    MiniBorderGradient.Rotation = 45
    MiniBorderGradient.Parent = MiniBorder
    ...
    coroutine.wrap(function()
        wait(0.5)
        Main:TweenSize(UDim2.new(0, 200, 0, 100), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 1, true)
    ...
    function tabhold:Tab(text)
        ...
        TabBorder.BackgroundColor3 = Color3.fromRGB(0, 100, 255)
        ...
        TabBorderGradient.Parent = TabBorder
        ...
        function tabcontent:Toggle(text,default, callback)
            ...
            FrameToggle1.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            SlideFrame.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            FrameRainbowToggle1.BackgroundColor3 = Color3.fromRGB(40, 40, 50)
            ...
            FrameRainbowToggle3.BackgroundColor3 = Color3.fromRGB(20, 20, 30)
        ...
        function tabcontent:Textbox(text, disapper, callback)
            ...
            TextboxFrame.BackgroundColor3 = Color3.fromRGB(15, 15, 25)
        ...
        function tabcontent:Bind(text, keypreset, callback)
            ...
            Bind.BackgroundTransparency = 0.6
